(function() {
  ...
  Lexer = (function() {
    var BETWEEN, BOOLEAN, COMMA, DBLSTRING, LITERAL, MATH, MATH_MULTI, NUMBER, PARAMETER, SEMICOLON, SQL_CONDITIONALS, SQL_FUNCTIONS, SQL_OPERATORS, SQL_SORT_ORDERS, STAR, STRING, SUB_SELECT_OP, SUB_SELECT_UNARY_OP, UNKNOWN, WHITESPACE;
    ...
    class Lexer {
      ...
      windowExtension() {
        var match;
        match = /^\.(win):(length|time)/iu.exec(this.chunk);
        if (!match) {
          return 0;
        }
